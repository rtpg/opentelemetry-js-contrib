...
## [0.2.0](https://github.com/open-telemetry/opentelemetry-js-contrib/compare/mongodb-example-v0.1.0...mongodb-example-v0.2.0) (2024-02-19)
...
* The following workspace dependencies were updated
  * dependencies
    * @opentelemetry/instrumentation-mongodb bumped from ^0.32.0 to ^0.39.1
